                                    ...
                                    <tr>
                                        ...
                                        <td class="product-detail">
                                            <div class="product border-0">
                                                <a href="{{route('product.showByID',$orderItem->product_id)}}"
                                                   class="product-image">
                                                    <img src="{{$orderItem->product->poster->url}}"
                                                         class="img-fluid blur-up lazyload" alt="{{$orderItem->product->name_en}}">
                                                </a>
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a href="{{route('product.showByID',$orderItem->product_id)}}">{{$orderItem->product->name_en}}</a>
                                                        </li>

                                                        {{-- <li class="text-content">Sold By: Fresho</li>--}}
                                                        {{--<li class="text-content">{{$orderItem->product->name_en}}</li>--}}
                                                    </ul>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="price">
                                            ...
                                            <h6 class="theme-color">${{$orderItem->unit_price}}</h6>
                                        </td>

                                        <td class="quantity">
                                            <h4 class="table-title text-content">Qty</h4>
                                            <h4 class="text-title">{{$orderItem->count}}</h4>
                                        </td>
                        ...
                        <div class="col-lg-12 col-sm-6">
                            <div class="summery-box">
                                <div class="summery-header">
                                    <h3>Price Details</h3>
                                    <h5 class="ms-auto theme-color">({{$order->orderItem->count()}} Items)</h5>
                                </div>
                        ...
                        <div class="col-lg-12 col-sm-6">
                            <div class="summery-box">
                                ...
                                <ul class="summery-contain pb-0 border-bottom-0">
                                    <li class="d-block">
                                        <h4>{{$order->shippingInfo->address_1}}</h4>
                                    </li>
