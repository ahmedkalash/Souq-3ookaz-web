                                ...
                                @foreach($cartItems as $cartItem)
                                    <tr>
                                                ...
                                                <div class="product-detail">
                                                    <ul>
                                                       ...
                                                       {{-- <li class="text-content">Sold By: Fresho</li>--}}
                                                        <li class="text-content">Quantity: {{$cartItem->amount}}</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="price">
                                            ...
                                            <h6 class="theme-color">${{$cartItem->unit_price}}</h6>
                                        </td>

                                        <td class="quantity">
                                            <h4 class="table-title text-content">Qty</h4>
                                            <h4 class="text-title">{{$cartItem->amount}}</h4>
                                        </td>
                        ...
                        <div class="col-lg-12 col-sm-6">
                            <div class="summery-box">
                                <div class="summery-header">
                                    <h3>Price Details</h3>
                                    <h5 class="ms-auto theme-color">({{$cartItems->count()}} Items)</h5>
                                </div>
                        ...
                        <div class="col-lg-12 col-sm-6">
                            <div class="summery-box">
                                ...
                                <ul class="summery-contain pb-0 border-bottom-0">
                                    <li class="d-block">
                                        <h4>{{$order->shipping_info->address_1}}</h4>
                                    </li>
                            ...
                            <div class="summery-box">
                                ...
                                <ul class="summery-contain pb-0 border-bottom-0">
                                    <li class="d-block pt-0">
                                        <p class="text-content">Pay on Delivery (Cash/Card). Cash on delivery (COD) available.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
