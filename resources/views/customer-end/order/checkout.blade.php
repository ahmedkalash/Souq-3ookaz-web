...
@section('content')
    ...
    @include(\App\View\ViewPath::BREADCRUMB)
            ...
            <div class="row g-sm-4 g-3">
                <div class="col-lg-8">
                    <div class="left-sidebar-checkout">
                        <form class="row g-4" id="order-form" action="{{route('checkout')}}" method="post">
                            @csrf
                                                ...
                                                <div class="col-xxl-6 col-lg-12 col-md-6">
                                                    ...
                                                    <div>
                                                        <div class="mb-4 row align-items-center">
                                                            <label class="form-label-title col-sm-3 mb-0">Your Full Name</label>
                                                            <div class="col-sm-9">
                                                                <input class="form-control" type="text" placeholder="Your Full Name" name="customer_full_name" required>
                                                            </div>
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            <label class="form-label-title col-sm-3 mb-0">Your Address</label>
                                                            <div class="col-sm-9">
                                                                <input class="form-control" type="text" placeholder="Your Address" name="address_1" required>
                                                            </div>
                                                            @error('address_1')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                            @enderror
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            <label class="form-label-title col-sm-3 mb-0">Optional Address</label>
                                                            <div class="col-sm-9">
                                                                <input class="form-control" type="text" placeholder="Your Optional Address" name="address_2" >
                                                            </div>
                                                            @error('address_2')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                            @enderror
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            <label class="form-label-title col-sm-3 mb-0">Governorate</label>
                                                            <div class="col-sm-9">
                                                                <input class="form-control" type="text" placeholder="Your Governorate" name="state" required>
                                                            </div>
                                                            @error('state')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                            @enderror
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            <label class="form-label-title col-sm-3 mb-0">Country</label>
                                                            <div class="col-sm-9">
                            ...
                            <ul class="summery-contain">
                                @foreach($cartItems as $cartItem)
                                    <li>
                                        ...
                                        <h4><span> {{$cartItem->amount}}X </span> {{$cartItem->name_en}}</h4>
                                        <h4 class="price">${{$cartItem->unit_price}}</h4>
                                    </li>
                                @endforeach
